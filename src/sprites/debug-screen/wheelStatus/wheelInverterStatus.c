...
#ifndef LV_ATTRIBUTE_IMG_WHEELINVERTERSTATUS
#define LV_ATTRIBUTE_IMG_WHEELINVERTERSTATUS
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_WHEELINVERTERSTATUS uint8_t wheelInverterStatus_map[] = {
...
const lv_img_dsc_t wheelInverterStatus = {
